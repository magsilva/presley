...
//		runLogin.run(null);
	...
	private void RunAssociaConhecimentoAtividade(){
		com.hukarz.presley.client.gui.action.RunAssociaConhecimentoAtividadeWizardAction runLogin = new com.hukarz.presley.client.gui.action.RunAssociaConhecimentoAtividadeWizardAction(this);
		runLogin.run(null);
	}
