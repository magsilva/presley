...
public class Inferencia implements Inference {
	...
	/*	1� Passo 
	(Analisar a participa��o de cada Desenvolvedor nos Arquivos)
	 */
	...
	/*	2� Passo 
	(Analisar a participa��o de cada Desenvolvedor nas resolucao de problemas
	...
	/*	3� Passo 
	(Soma os vetores de participa��o dos Desenvolvedor nos Arquivos e nas mensagens)
	 */
	...
	// Metodo para classificar os desenvolvedores por participa��o
	protected Map<Desenvolvedor, Integer> classificacarDesenvolvedores( Map<Desenvolvedor, Integer> participacaoDesenvolvedor,
		...
		for (Iterator<Desenvolvedor> it = participacaoDesenvolvedor.keySet().iterator(); it.hasNext();) {
			...
			// Se o desenvolvedor tiver a maior participa��o encontrada  
			...
			// Se o desenvolvedor tiver a menor participa��o encontrada
				...
				menorParticipacao = participacao;
			// Se o desenvolvedor tiver uma participa��o entre a maior e a menor
			} else {
				for (int i = 0; i < classificacaoDesenvolvedores.length; i++) {
